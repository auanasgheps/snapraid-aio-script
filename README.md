...
- Command line arguments
  	...
  	- You can force syncing zero-length files by adding `--force-zero`
...
| --force-zero  | Forces the operation of syncing a file with zero size that before was not (overrides `FORCE_ZERO` in config).  |
